...
attribute [implicit_reducible]
  IntermediateField.copy Subalgebra.copy Submonoid.copy Subsemiring.copy Subsemigroup.copy
  Set.inter Set.union Set.iInter Set.iUnion Set.sInter
  _root_.iInf Set Set.range AlgHom.range IntermediateField.gi
  Subfield.gi Algebra.gi Subfield.closure Subring.mk' Subsemiring.mk'
  RingHom.rangeS RingHom.range Subring.closure Subfield.toIntermediateField IntermediateField.adjoin
