...
attribute [local semireducible]
  Add.add AddMonoid.nsmul Algebra.gi CoeHTC.coe CoeHTCT.coe CoeOTC.coe CoeOut.coe
  CoeSort.coe CoeT.coe HAdd.hAdd HMul.hMul HPow.hPow HSMul.hSMul Inter.inter
  IntermediateField.copy IntermediateField.gi LE.le Lattice.inf Membership.mem
  Min.min Monoid.npow Mul.mul OfNat.ofNat One.one Pow.pow SMul.smul
  SemilatticeInf.inf Set Set.Mem SetLike.coe Subalgebra.copy Zero.zero
  Max.max SemilatticeSup.sup
