...
trace: [Meta.synthInstance] ❌️ Mono (kernel.ι (cokernel.π f))
  [Meta.synthInstance.apply] ❌️ apply @equalizer.ι_mono to Mono (kernel.ι (cokernel.π f))
    [Meta.synthInstance.tryResolve] ❌️ Mono (kernel.ι (cokernel.π f)) ≟ Mono (equalizer.ι ?m.244 ?m.245)
      [Meta.isDefEq] ❌️ Mono (kernel.ι (cokernel.π f)) =?= Mono (equalizer.ι ?m.244 ?m.245)
        [Meta.isDefEq] ❌️ kernel.ι (cokernel.π f) =?= equalizer.ι ?m.244 ?m.245
          [Meta.isDefEq] ❌️ equalizer.ι (cokernel.π f) 0 =?= equalizer.ι ?m.244 ?m.245
            [Meta.isDefEq] ❌️ kernelOrderHom._proof_1 X (op (cokernel f)) (cokernel.π f).op =?= ?m.246
              [Meta.isDefEq.assign.checkTypes] ❌️ (?m.246 : HasEqualizer (cokernel.π f)
                ...
                [Meta.isDefEq] ❌️ HasEqualizer (cokernel.π f) 0 =?= HasKernel (cokernel.π f).op.unop
                  [Meta.isDefEq] ❌️ HasLimit
                        (parallelPair (cokernel.π f) 0) =?= HasLimit (parallelPair (cokernel.π f).op.unop 0)
                    [Meta.isDefEq] ❌️ parallelPair (cokernel.π f) 0 =?= parallelPair (cokernel.π f).op.unop 0
                      [Meta.isDefEq] ❌️ cokernel.π f =?= (cokernel.π f).op.unop
                        [Meta.isDefEq] ❌️ coequalizer.π f 0 =?= (cokernel.π f).op.unop
                          [Meta.isDefEq] ❌️ colimit.ι (parallelPair f 0)
                                WalkingParallelPair.one =?= (cokernel.π f).op.unop
                            [Meta.isDefEq] ❌️ @colimit.ι =?= @Quiver.Hom.unop
                    ...
                    [Meta.isDefEq.onFailure] ❌️ HasLimit
                          (parallelPair (cokernel.π f) 0) =?= HasLimit (parallelPair (cokernel.π f).op.unop 0)
            [Meta.isDefEq] ❌️ limit.π (parallelPair (cokernel.π f) 0)
