...
noncomputable abbrev groupCohomologyIso₀ :
    groupCohomology A 0 ≅ ↧(LinearMap.ker (applyAsHom A g - 𝟙 A).hom.toLinearMap) :=
...
noncomputable abbrev groupCohomologyπEven (i : ℕ) [NeZero i] (hi : Even i) :
    ↧(LinearMap.ker (applyAsHom A g - 𝟙 A).hom.toLinearMap) ⟶ groupCohomology A i :=
...
noncomputable abbrev groupCohomologyπOdd (i : ℕ) (hi : Odd i) :
    ↧(LinearMap.ker A.norm.hom.toLinearMap) ⟶ groupCohomology A i :=
